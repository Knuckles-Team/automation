...
mkdir C:\temp\
Invoke-WebRequest -Uri "https://www.python.org/ftp/python/3.8.2/python-3.8.2.exe" -OutFile "C:/temp/python-3.8.2.exe"
...
# Install exes
#C:/temp/python-3.8.2.exe /quiet InstallAllUsers=0 PrependPath=1 Include_test=0
#C:/temp/pycharm.exe /quiet InstallAllUsers=0 PrependPath=1 Include_test=0
